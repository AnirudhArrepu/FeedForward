        ...
        body: GestureDetector(
          ...
          child: LeaderboardClass.userPointsVolunteers.length == 0
            ...
            Container(
              color: const Color.fromARGB(255, 35, 137, 38),
              height: 500,
              child: LeaderboardClass.userPointsVolunteers.isEmpty
                  ? const CircularProgressIndicator()
                  : ListView.builder(
                      itemCount:
                          LeaderboardClass.userPointsDonations.length < 10
                              ? LeaderboardClass.userPointsDonations.length
                              : 10,
                      itemBuilder: (BuildContext context, int index) {
                        String user = LeaderboardClass
                            .userPointsSortedDonations.entries
                            .toList()[index]
                            .key;
                        return ListTile(
                          leading: Text(
